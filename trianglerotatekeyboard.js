...
var wasmBinaryFile = 'trianglerotatekeyboard.wasm';
...
// {{PRE_LIBRARY}}
  ...
  function _glActiveTexture(x0) { GLctx['activeTexture'](x0) }var GLEmulation={fogStart:0,fogEnd:1,fogDensity:1,fogColor:null,fogMode:2048,fogEnabled:false,pointSize:1,vaos:[],currentVao:null,enabledVertexAttribArrays:{},hasRunInit:false,findToken:function(source, token) {
...
var asmLibraryArg = { "emscripten_get_sbrk_ptr": _emscripten_get_sbrk_ptr, "emscripten_resize_heap": _emscripten_resize_heap, "glBegin": _glBegin, "glEnd": _glEnd, "glRotatef": _glRotatef, "glVertex2f": _glVertex2f, "glutCreateWindow": _glutCreateWindow, "glutDisplayFunc": _glutDisplayFunc, "glutIdleFunc": _glutIdleFunc, "glutInit": _glutInit, "glutInitWindowSize": _glutInitWindowSize, "glutKeyboardFunc": _glutKeyboardFunc, "glutKeyboardUpFunc": _glutKeyboardUpFunc, "glutMainLoop": _glutMainLoop, "glutPostRedisplay": _glutPostRedisplay, "glutSpecialFunc": _glutSpecialFunc, "glutSpecialUpFunc": _glutSpecialUpFunc, "memory": wasmMemory, "table": wasmTable };
var asm = createWasm();
/** @type {function(...*):?} */
